...
# Function to identify Inside Range Break signals
def inside_range_break(df):
    df['signal'] = 0
...
# Identify Inside Range Break signals
df = inside_range_break(df)
...
plt.title('EURUSD Inside Range Break Signals')
plt.legend()
plt.show()
