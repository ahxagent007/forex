...
class ThreeSoldier(CandlestickFinder):
    ...
    def logic(self, idx):
        ...
        #         close > b_prev_close)
        print(close,'  ',close)
        return (close > open and prev_close > prev_open and b_prev_close > b_prev_open) and (prev_open> b_prev_open and open > prev_open ) and (prev_close> b_prev_close and close > prev_close )
