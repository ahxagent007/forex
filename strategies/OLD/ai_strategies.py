...
#             df = get_live_data(symbol=symbol, time_frame=time_frame, prev_n_candles=3000)
#
#             avg_candle_size, sl, tp = get_avg_candle_size(symbol, df, 3, 1)
#             trade_order(symbol=symbol, tp_point=tp, sl_point=sl, lot=lot, action=signal, magic=True)
#             write_json(json_dict=orders_json, json_file_name=json_file_name)