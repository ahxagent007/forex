...
def check_status(symbol):
    ...
    if isNowInTimePeriod(dt.time(ORB_START_HOUR, ORB_START_MIN), dt.time(ORB_END_HOUR, ORB_END_MIN), dt.datetime.now().time()):
        try:
...
SYMBOL_LIST = ['XAUUSD', 'EURUSD', 'BTCUSD']
    ...
    for symbol in SYMBOL_LIST:
        ...
        if ready_trade:
            ...
            if data_df['close'].iloc[-2] > orb_high:
                ...
                tp_2 = entry_price_2 + orb_diff
                tp_3 = entry_price_3 + orb_diff
